...
class HealthConnectManager(private val context: Context) {
  ...
  suspend fun readStepSessions(start: Instant, end: Instant): MutableList<StepsRecord> {
    val request = ReadRecordsRequest(
      recordType = StepsRecord::class,
      timeRangeFilter = TimeRangeFilter.between(start, end)
    )
    val response = healthConnectClient.readRecords(request)
    Log.i("demotest",response.records.size.toString())
    return response.records.toMutableList()
  }

  suspend fun readTotalCaloriesSessions(start: Instant, end: Instant): MutableList<TotalCaloriesBurnedRecord> {
    val request = ReadRecordsRequest(
  ...
  suspend fun readBasalCaloriesSessions(start: Instant, end: Instant): MutableList<BasalMetabolicRateRecord> {
    val request = ReadRecordsRequest(
  ...
  suspend fun readDistanceSessions(start: Instant, end: Instant): MutableList<DistanceRecord> {
    val request = ReadRecordsRequest(
